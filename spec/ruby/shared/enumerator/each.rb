...
describe :enum_each, :shared => true do
  before(:each) do
    @objet_each_with_arguments = Object.new
    def @objet_each_with_arguments.each_with_arguments(arg, *args)
      yield arg, *args
      :method_returned
    end

    @enum_with_arguments = @objet_each_with_arguments.to_enum(:each_with_arguments, :arg0, :arg1, :arg2)
  end
